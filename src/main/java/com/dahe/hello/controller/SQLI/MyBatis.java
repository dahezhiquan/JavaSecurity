package com.dahe.hello.controller.SQLI;

import com.dahe.hello.entity.User;
import com.dahe.hello.mapper.UserMapper;
...
public class MyBatis {
    ...
    /**
     * @poc http://127.0.0.1:8888/SQLI/MyBatis/vul/order?field=id&sort=desc,abs(111111)
     */
