...
import com.dahe.hello.controller.XXE.Student;
...
public class Deserialization {
     ...
     * payload：java -jar ysoserial.jar CommonsCollections5 "open -a Calculator" | base64
     */
    ...
    public String readObject(String base64) {
        try {
            ...
            return "Payload：java -jar ysoserial.jar CommonsCollections5 \"open -a Calculator\" | base64";
        }
    }
